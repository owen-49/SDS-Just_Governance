            ...
            <div key={sec.id}>
              ...
              <div
                style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '6px 8px', cursor: 'pointer', borderRadius: 8,
                         background: ui.sectionsOpen?.[sec.id] || query ? 'rgba(148,163,184,0.08)' : 'transparent' }}
                    ...
                    <div key={mod.id}>
                      ...
                      <div
                        style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '6px 12px', cursor: 'pointer', opacity: 0.98, borderRadius: 8,
                                 background: ui.modulesOpen?.[mod.id] || query ? 'rgba(148,163,184,0.06)' : 'transparent' }}
